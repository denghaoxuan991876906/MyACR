...
public class 猛枪 : ISlotResolver
{
    public int Check()
    {
        ...
        if (CooldownHelper.GetCooldownRemaining(DRGHelper.猛枪) > 0) return (int)CheckResult.冷却中;
    ...
    {
        slot.Add(new Spell { Id = DRGHelper.猛枪, TargetType = SpellTargetType.Self, Type = SpellType.Ability });
    }
}
